    ...
    <div class="slider" id="slider">
      ...
      <img src="../IMG/alcobas.jpg" alt="" class="slider__img">> 
        <div class="slider__content">
          ...
          <a href="alcoba.blade.php" class="btn-shop">Ver Producto</a>
        </div>
      </div>
      ...
      <div class="slider__section">
        ...
        <div class="slider__content" id="carucel3">
          ...
          <a href="{{route('comedor')}}" class="btn-shop">Ver Producto</a>
        </div>
      </div>
      <div class="slider__section">
        ...
        <div class="slider__content" id="carucel4">
          <h2 class="slider__title">COMEDORES</h2>
          <a href="comedor.blade.php" class="btn-shop">Ver Producto</a>
        </div>
      </div>
    </div>
